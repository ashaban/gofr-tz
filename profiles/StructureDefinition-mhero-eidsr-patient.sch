...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://mHero.org/fhir/StructureDefinition/mhero-eidsr-suspected-case']) &gt;= 1">extension with URL = 'http://mHero.org/fhir/StructureDefinition/mhero-eidsr-suspected-case': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://mHero.org/fhir/StructureDefinition/mhero-eidsr-suspected-case']) &lt;= 1">extension with URL = 'http://mHero.org/fhir/StructureDefinition/mhero-eidsr-suspected-case': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
